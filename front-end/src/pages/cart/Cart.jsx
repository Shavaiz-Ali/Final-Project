    ...
    <div className="mx-auto overflow-hidden" data-aos="zoom-in">
      ...
      {products.length > 0 ? (
          ...
          <div className="lg:flex justify-between gap-4 w-full">
            <div className="border w-full">
              <div className="flex justify-around items-center">
                ...
                <h3 className="font-[500] text-[16px] mt-4 lg:mt-0">
                  Quantity
                </h3>
                <h3 className="font-[500] text-[16px] mt-4 lg:mt-0">
                  Sub Total
              ...
              <div className="flex justify-between items-center border-t border-black/[0.15] py-4 sm:px-8 px-1 ">
                <div className="flex  items-center sm:gap-4 gap-1">
                  <input
                    ...
                    className="sm:w-[200px] w-[100px] px-2 h-[40px] text-[14px] border border-black/[0.15] outline-none"
                  />
                  <h1 className="sm:text-[18px] text-[13px] sm:font-[600] font-[300]">
                    Apply Coupon
                  </h1>
                </div>
                <h1 className="sm:text-[18px] text-[13px] sm:font-[600] font-[300]">
            ...
            <div className="flex flex-col justify-items-end items-end bg-black/[0.12] py-2 px-3 lg:my-0 my-2">
              ...
              <div className="flex flex-col border justify-between border-black/[0.15] sm:w-[350px] w-[95%] mt-4">
                <h1 className="flex justify-between md:text-xl sm:text-[16px] text-[13px] font-[600] py-2 px-3">
                  SubTotal
                  <span>${totalAmt}</span>
                </h1>
                <h1 className="flex justify-between border-t border-black/[0.15] md:text-xl sm:text-[16px] text-[13px] font-[600] py-2 px-3">
                  Shipping Charges
        ...
        <div className=" text-[3rem] text-black font-[700] uppercase flex flex-col justify-center items-center transtion-all duration-700 ease-in-out scale-110 h-[50vh]">
          ...
          <Link
            to={"/"}
            className="flex justify-center items-center text-[16px] py-3 text-white bg-[#2AC37D] rounded-[50px] w-[200px] mt-5 shadow-black/[0.15] shadow-lg font-semibold hover:bg-[#30d68b] transition-all duration-300 ease-out"
          >
            Continue Shopping
          </Link>
        </div>
