    ...
    <div className="flex justify-around items-center">
      ...
      <div className="flex flex-col md:col-span-4 col-span-6">
        <div className="flex gap-5 items-center mt-1">
          <span
            className="sm:text-2xl text-[16px] flex items-center justify-center cursor-pointer duration-300 "
          ...
          <span
            className="m:text-2xl text-[16px] flex items-center justify-center  cursor-pointer duration-300"
